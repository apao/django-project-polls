...
class IndexView(generic.ListView):
    ...
    def get_queryset(self):
        """Return the last five published questions but not future questions."""
...
def vote(request, question_id):
    ...
    try:
        ...
        # Return HttpResponseRedirect to prevent data from being posted twice if a user hits the Back button.
